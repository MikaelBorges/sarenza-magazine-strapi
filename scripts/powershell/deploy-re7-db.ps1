...
helm upgrade -i --wait strapi-db ./helm/sarenza-digitalexperience-cms-database/postgresql --tiller-namespace digitalexperience-re7-tiller --namespace digitalexperience-re7
# --recreate-pods