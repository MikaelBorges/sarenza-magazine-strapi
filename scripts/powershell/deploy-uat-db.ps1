...
kubectl create --namespace digitalexperience-uat configmap init-database-strapi --from-file=helm/sarenza-digitalexperience-cms-database/init.sql
helm upgrade -i --wait strapi-db ./helm/sarenza-digitalexperience-cms-database/postgresql --tiller-namespace digitalexperience-uat-tiller --namespace digitalexperience-uat
# --recreate-pods